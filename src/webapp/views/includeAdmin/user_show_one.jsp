        ...
        <c:if test="${not empty userOne}">
            <table class="table table-condensed table-bordered">
                <tr>
                    ...
                    <td align="center" style="border-color: #20B2AA"><fmt:message key="table.user.firstname"/></td>
                    <td align="center" style="border-color: #20B2AA"><fmt:message key="table.user.lastname"/></td>
