    ...
    <div class="col-md-6 col-md-offset-6">
        <table class="table table-condensed table-bordered">
            <tr>
                ...
                <td align="center" style="border-color: #dae5ff"><fmt:message key="table.user.firstname"/></td>
                <td align="center" style="border-color: #dae5ff"><fmt:message key="table.user.lastname"/></td>
