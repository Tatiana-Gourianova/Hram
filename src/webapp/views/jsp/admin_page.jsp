            ...
            <div class="col-md-10 col-md-offset-1">
                <table class="table table-condensed table-bordered">
                    <tr class="active">
                        ...
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.user.firstname"/></td>
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.user.lastname"/></td>
