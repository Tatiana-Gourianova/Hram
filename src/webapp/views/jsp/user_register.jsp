...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form action="UserResource" method="post" class="form-horizontal">
                <input type="hidden" name="registration" value="new">

                <div class="form-group">
                    <label for="firstnameForm" class="col-sm-3 control-label"><fmt:message key="register.form.firstname"/></label>
                    <div class="col-sm-9">
                        <input type="text" id="firstnameForm" name="firstname" class="form-control" placeholder="<fmt:message key="register.form.firstname.placeholder"/>"
                               onKeyup="checkData('firstname')" maxlength="10" required pattern="([A-Z]?[a-z]{1,10})|([А-ЯЁ]?[а-яё]{1,10})">
                        <b id="first_name" style="color: red; font-size: 10px"><fmt:message key="validation.firstname"/></b>
                    </div>
                </div>
                <div class="form-group">
                    <label for="lastnameForm" class="col-sm-3 control-label"><fmt:message key="register.form.lastname"/></label>
                    <div class="col-sm-9">
                        <input type="text" id="lastnameForm" name="lastname" class="form-control" placeholder="<fmt:message key="register.form.lastname.placeholder"/>"
                               onKeyup="checkData('lastname')" maxlength="10" required pattern="([A-Z]?[a-z]{1,10})|([А-ЯЁ]?[а-яё]{1,10})">
                        <b id="last_name" style="color: red; font-size: 10px"><fmt:message key="validation.lastname"/></b>
                    </div>
                </div>
                <div class="form-group">
